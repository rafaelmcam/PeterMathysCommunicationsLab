...
class am_rcv01(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "am_rcv01")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("am_rcv01")
        ...
        self.settings = Qt.QSettings("GNU Radio", "am_rcv01")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate2,True)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate2, analog.GR_COS_WAVE, fcorr, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate2, analog.GR_COS_WAVE, fc, 1, 0, 0)
...
def main(top_block_cls=am_rcv01, options=None):
