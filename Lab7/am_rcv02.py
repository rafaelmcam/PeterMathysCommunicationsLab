...
# Title: am_rcv02
# Author: rcampello
# GNU Radio version: v3.10.0.0git-434-g078d40dd
...
class am_rcv02(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "am_rcv02", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("am_rcv02")
        ...
        self.settings = Qt.QSettings("GNU Radio", "am_rcv02")
        ...
        self._fcorr_win = RangeWidget(self._fcorr_range, self.set_fcorr, 'Fine Tune', "counter_slider", float, QtCore.Qt.Horizontal)
    ...
    def set_samp_rate2(self, samp_rate2):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(2, self.samp_rate2, 4000, 2000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=am_rcv02, options=None):
