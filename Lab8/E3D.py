...
class E3D(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._gain_range = Range(0, 4, 1, 1, 200)
        self._gain_win = RangeWidget(self._gain_range, self.set_gain, 'gain', "counter_slider", float)
        self.top_grid_layout.addWidget(self._gain_win)
        self._fc_Xmtr_range = Range(-300000, 300000, 0.1, 230000, 200)
        ...
        self.connect((self.ASKrcvr_cb_0, 4), (self.blocks_file_sink_0_1, 0))
        self.connect((self.ASKrcvr_cb_0, 5), (self.blocks_file_sink_0_1_0, 0))
        self.connect((self.ASKrcvr_cb_0, 4), (self.blocks_null_sink_0, 0))
        self.connect((self.ASKrcvr_cb_0, 5), (self.blocks_null_sink_0_0, 0))
        self.connect((self.ASKrcvr_cb_0, 3), (self.blocks_null_sink_0_1, 0))
