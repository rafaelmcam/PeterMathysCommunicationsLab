...
from ModuleLab3 import generate_signal_E3C
...
class E3C(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f(generate_signal_E3C(samp_rate, f1), True, 1, [tag1])
    ...
    def set_tag1(self, tag1):
        self.tag1 = tag1
        self.blocks_vector_source_x_0.set_data(generate_signal_E3C(self.samp_rate, self.f1), [self.tag1])
