...
class E2C(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._sps_range = Range(2, 50, 1, 5, 200)
        self._sps_win = RangeWidget(self._sps_range, self.set_sps, 'sps', "counter_slider", int)
        self.top_grid_layout.addWidget(self._sps_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.top_grid_layout.addWidget(self._ptype_tool_bar, 0, 1, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_sink_x_0_win, 0, 2, 3, 2)
        for r in range(0, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_fff(sps, ptfun.pampt(sps, ptype, [k, beta]))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.interp_fir_filter_xxx_0.set_taps(ptfun.pampt(self.sps, self.ptype, [self.k, self.beta]))
