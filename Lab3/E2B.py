...
class E2B(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "E2B")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("E2B")
        ...
        self.settings = Qt.QSettings("GNU Radio", "E2B")
        ...
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.blocks_vector_source_x_0 = blocks.vector_source_c([np.exp(1j*phi1)], True, 1, [])
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.blocks_complex_to_real_0_0_0, 0))
        ...
        self.connect((self.blocks_vector_source_x_0, 0), (self.blocks_multiply_xx_0_0, 1))
    ...
    def set_phi1(self, phi1):
        self.phi1 = phi1
        self.blocks_vector_source_x_0.set_data([np.exp(1j*self.phi1)], [])
...
def main(top_block_cls=E2B, options=None):
