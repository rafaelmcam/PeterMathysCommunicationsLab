...
class E1B(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "E1-B")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("E1-B")
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(2.5)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, waveform, 2.5 * f0, 1, offset, 0)
    ...
    def set_f0(self, f0):
        ...
        self.analog_sig_source_x_0_0.set_frequency(2.5 * self.f0)
