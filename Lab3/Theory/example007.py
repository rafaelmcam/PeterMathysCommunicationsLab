...
# Title: example007
# Author: rcampello
# Description: PDF pula o label: "example006"
...
class example007(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "example007")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("example007")
        ...
        self.settings = Qt.QSettings("GNU Radio", "example007")
        ...
        self.blocks_add_const_vxx_0 = blocks.add_const_cc(-0.5-0.5j)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, waveform, f0, 1, offset, 0)
...
def main(top_block_cls=example007, options=None):
