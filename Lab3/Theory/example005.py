...
class example005(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "example005")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("example005")
        ...
        self.settings = Qt.QSettings("GNU Radio", "example005")
...
def main(top_block_cls=example005, options=None):
