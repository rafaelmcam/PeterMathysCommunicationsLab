...
class E1A(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "E1A")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("E1A")
        ...
        self.settings = Qt.QSettings("GNU Radio", "E1A")
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._f0_range = Range(-5000, 5000, 1, int(1.9e3), 200)
...
def main(top_block_cls=E1A, options=None):
