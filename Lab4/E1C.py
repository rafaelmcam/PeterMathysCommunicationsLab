...
class E1C(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "E1C")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("E1C")
        ...
        self.settings = Qt.QSettings("GNU Radio", "E1C")
        ...
        self.dsamp = dsamp = 8
        self.Fs1 = Fs1 = samp_rate
        self.usamp = usamp = 8
        self.Fs2 = Fs2 = Fs1 // dsamp
        self.waveform = waveform = 102
        self.offset = offset = 0
        self.nofpoints = nofpoints = 128
        self.k = k = 5
        self.fc = fc = Fs2
        self.f0 = f0 = int(0.2e3)
        self.dly = dly = 360
        self.Fs3 = Fs3 = Fs2 * usamp
        ...
        self.top_grid_layout.addWidget(self._waveform_group_box, 0, 0, 3, 1)
        for r in range(0, 3):
        ...
        self.top_grid_layout.addWidget(self._fc_win, 2, 1, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._f0_range = Range(-5000, 5000, 1, int(0.2e3), 200)
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._dly_range = Range(0, 1000, 1, 360, 200)
        self._dly_win = RangeWidget(self._dly_range, self.set_dly, 'dly', "counter_slider", int)
        self.top_grid_layout.addWidget(self._dly_win, 8, 0, 1, 1)
        for r in range(8, 9):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.qtgui_time_sink_x_0_0_0_0_0.set_y_label('Amplitude', "x(t)")
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_0_0_0_0_win, 6, 0, 2, 2)
        for r in range(6, 8):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_time_sink_x_0_0_0_0 = qtgui.time_sink_f(
            nofpoints * 3, #size
            Fs3, #samp_rate
            "Reconstructed 'CT' Waveform (at Fs3)", #name
            1 #number of inputs
        )
        self.qtgui_time_sink_x_0_0_0_0.set_update_time(0.10)
        self.qtgui_time_sink_x_0_0_0_0.set_y_axis(-1, 1)

        self.qtgui_time_sink_x_0_0_0_0.set_y_label('Amplitude', "x(t)")
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_0_0_0_win, 4, 1, 1, 1)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_time_sink_x_0_0_0 = qtgui.time_sink_f(
            nofpoints, #size
            Fs3, #samp_rate
            "DT Waveform Upsampled at Fs3", #name
            1 #number of inputs
        )
        self.qtgui_time_sink_x_0_0_0.set_update_time(0.10)
        self.qtgui_time_sink_x_0_0_0.set_y_axis(-1, 1)

        self.qtgui_time_sink_x_0_0_0.set_y_label('Amplitude', "x[n/usamp]")
        ...
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_f(
            nofpoints, #size
            Fs2, #samp_rate
            "DT Waveform, sampled at Fs2", #name
            1 #number of inputs
        )
        self.qtgui_time_sink_x_0_0.set_update_time(0.10)
        self.qtgui_time_sink_x_0_0.set_y_axis(-1, 1)

        self.qtgui_time_sink_x_0_0.set_y_label('Amplitude', "x[n]")
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            nofpoints, #size
            Fs1, #samp_rate
            "Original CT waveform at Fs1", #name
            1 #number of inputs
        )
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.interp_fir_filter_xxx_0_0 = filter.interp_fir_filter_fff(1, 2*np.cos(2*np.pi*fc/float(Fs3) * np.arange(-k*usamp, k*usamp)) * pf.pampt(usamp, 'sinc', [k, 2.6]))
        ...
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(Fs1, waveform, fc - f0, 1, offset, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(Fs1, waveform, fc + f0, 1, offset, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, waveform, f0, 1, offset, 0)
        ...
        self.connect((self.blocks_delay_0, 0), (self.qtgui_time_sink_x_0_0_0_0_0, 1))
        ...
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0_0, 0))
    ...
    def set_dsamp(self, dsamp):
        self.dsamp = dsamp
        self.set_Fs2(self.Fs1 // self.dsamp)
    ...
    def set_Fs1(self, Fs1):
        ...
        self.analog_sig_source_x_0_0_0.set_sampling_freq(self.Fs1)
    ...
    def set_usamp(self, usamp):
        self.usamp = usamp
        self.set_Fs3(self.Fs2 * self.usamp)
        self.interp_fir_filter_xxx_0_0.set_taps(2*np.cos(2*np.pi*self.fc/float(self.Fs3) * np.arange(-self.k*self.usamp, self.k*self.usamp)) * pf.pampt(self.usamp, 'sinc', [self.k, 2.6]))
    ...
    def set_Fs2(self, Fs2):
        ...
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.Fs2)
    ...
    def set_waveform(self, waveform):
        ...
        self.analog_sig_source_x_0_0_0.set_waveform(self.waveform)
    ...
    def set_offset(self, offset):
        ...
        self.analog_sig_source_x_0_0_0.set_offset(self.offset)

    def get_nofpoints(self):
        return self.nofpoints

    def set_nofpoints(self, nofpoints):
        self.nofpoints = nofpoints
    ...
    def set_fc(self, fc):
        self.fc = fc
        self.analog_sig_source_x_0_0.set_frequency(self.fc + self.f0)
        self.analog_sig_source_x_0_0_0.set_frequency(self.fc - self.f0)
        self.interp_fir_filter_xxx_0_0.set_taps(2*np.cos(2*np.pi*self.fc/float(self.Fs3) * np.arange(-self.k*self.usamp, self.k*self.usamp)) * pf.pampt(self.usamp, 'sinc', [self.k, 2.6]))
    ...
    def set_Fs3(self, Fs3):
        self.Fs3 = Fs3
        self.interp_fir_filter_xxx_0_0.set_taps(2*np.cos(2*np.pi*self.fc/float(self.Fs3) * np.arange(-self.k*self.usamp, self.k*self.usamp)) * pf.pampt(self.usamp, 'sinc', [self.k, 2.6]))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.Fs3)
        self.qtgui_time_sink_x_0_0_0.set_samp_rate(self.Fs3)
        self.qtgui_time_sink_x_0_0_0_0.set_samp_rate(self.Fs3)
        self.qtgui_time_sink_x_0_0_0_0_0.set_samp_rate(self.Fs3)



def main(top_block_cls=E1C, options=None):
