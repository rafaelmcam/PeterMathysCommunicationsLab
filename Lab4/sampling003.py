...
class sampling003(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "sampling003")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("sampling003")
        ...
        self.settings = Qt.QSettings("GNU Radio", "sampling003")
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._fc_range = Range(-16000, 16000, 1, int(4e3), 200)
...
def main(top_block_cls=sampling003, options=None):
