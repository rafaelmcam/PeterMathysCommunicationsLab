...
class sampling002(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "sampling002")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("sampling002")
        ...
        self.settings = Qt.QSettings("GNU Radio", "sampling002")
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._f0_range = Range(-5000, 5000, 1, int(2.7e3), 200)
...
def main(top_block_cls=sampling002, options=None):
