...
class E1B(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "E1B")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("E1B")
        ...
        self.settings = Qt.QSettings("GNU Radio", "E1B")
        ...
        self._waveform_options = (103, 102, 104, )
        # Create the labels list
        self._waveform_labels = ('Rectangular', 'Cosine', 'Triangular', )
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._f0_range = Range(-5000, 5000, 1, int(1.2e3), 200)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_0_0_0_win, 3, 1, 1, 1)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.interp_fir_filter_xxx_0_0 = filter.interp_fir_filter_fff(1, pf.pampt(usamp, 'sinc', [5, 2.6]))
    ...
    def set_Fs1(self, Fs1):
        self.Fs1 = Fs1
        self.set_Fs2(self.Fs1 // self.dsamp)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(0, self.Fs1)
    ...
    def set_usamp(self, usamp):
        ...
        self.interp_fir_filter_xxx_0_0.set_taps(pf.pampt(self.usamp, 'sinc', [5, 2.6]))
...
def main(top_block_cls=E1B, options=None):
