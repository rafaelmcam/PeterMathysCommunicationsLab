...
class E2C(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "E2C")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("E2C")
        ...
        self.settings = Qt.QSettings("GNU Radio", "E2C")
        ...
        self.fL_div_by_FB = fL_div_by_FB = 0.1
        self.FB = FB = 32000
        ...
        # Blocks
        ##################################################
        self._fL_div_by_FB_range = Range(0.1, sps / 2, 0.5, 0.1, 200)
        ...
        self.top_grid_layout.addWidget(self._A_noise_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.qtgui_number_sink_1.set_title("Signal to Noise Ratio [dB]")
        ...
        self.qtgui_number_sink_0.set_title("Absolute Noise Power")
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('/home/rcampello/Main/3m/Simulação de sistemas de comunicação/Labs/Lab5/E2C-gnuradio-recording.wav', 1, samp_rate, 16)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, FB,True)
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_float*1, FB * 50)
        self.blocks_nlog10_ff_0 = blocks.nlog10_ff(10, 1, 0)
        self.blocks_multiply_xx_0_0 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(0.5)
        self.blocks_head_0 = blocks.head(gr.sizeof_float*1, FB * 100)
        self.blocks_divide_xx_0 = blocks.divide_ff(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_GAUSSIAN, A_noise, 0)
        print(analog.GR_UNIFORM)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.low_pass_filter_0_0_0_0, 0))
        ...
        self.connect((self.low_pass_filter_0_0_0, 0), (self.qtgui_number_sink_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, self.fL_div_by_FB * self.FB, self.fL_div_by_FB * self.FB / 20, firdes.WIN_HAMMING, 6.76))
    ...
    def set_FB(self, FB):
        self.FB = FB
        self.blocks_head_0.set_length(self.FB * 100)
...
def main(top_block_cls=E2C, options=None):
