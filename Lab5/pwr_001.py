...
class pwr_001(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "pwr_001")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pwr_001")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pwr_001")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, waveform, f0, A, offs, 0)
...
def main(top_block_cls=pwr_001, options=None):
