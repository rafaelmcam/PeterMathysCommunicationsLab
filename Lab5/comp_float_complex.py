...
class comp_float_complex(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "comp_float_complex")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("comp_float_complex")
        ...
        self.settings = Qt.QSettings("GNU Radio", "comp_float_complex")
        ...
        self.top_grid_layout.addWidget(self._waveform_group_box)
        ...
        self.analog_noise_source_x_0_0 = analog.noise_source_f(waveform, A, 0)
    ...
    def set_waveform(self, waveform):
        ...
        self.analog_noise_source_x_0_0.set_type(self.waveform)
    ...
    def set_A(self, A):
        ...
        self.analog_noise_source_x_0_0.set_amplitude(self.A)



def main(top_block_cls=comp_float_complex, options=None):
