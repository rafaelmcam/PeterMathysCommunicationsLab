...
class E1E(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "E1E")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("E1E")
        ...
        self.settings = Qt.QSettings("GNU Radio", "E1E")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, waveform, f0, A, offs, 0)
...
def main(top_block_cls=E1E, options=None):
